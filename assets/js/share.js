...
(function (global) {
  ...
  var PLATFORM_ICONS = {
    ...
    "macOS": '<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2A10 10 0 0 0 12 22Z"/><path opacity=".45" d="M12 2A10 10 0 0 1 12 22Z"/><circle cx="8.5" cy="10" r="1.3" fill="var(--surface)"/><circle cx="15.5" cy="10" r="1.3" fill="var(--surface)"/><path fill="none" stroke="var(--surface)" stroke-width="1.6" stroke-linecap="round" d="M8 13.5A4 3.5 0 0 1 16 13.5"/></svg>',
