...
(function (global) {
  ...
  var PLATFORM_ICONS = {
    ...
    "macOS": '<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path opacity=".22" d="M3 4a1 1 0 0 1 1-1h16a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V4zm2 1v10h14V5H5z"/><path opacity=".22" d="M6.5 18h11l2 2H4.5l2-2z"/><circle cx="9.5" cy="9.4" r="1.1"/><circle cx="14.5" cy="9.4" r="1.1"/><path fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" d="M8.6 11.6a3.4 2.6 0 0 1 6.8 0"/></svg>',
